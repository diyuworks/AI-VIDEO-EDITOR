  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-2 sm:p-4 space-y-10 font-sans">
      <div className="border-4 sm:border-[6px] border-[#0D473B] rounded-[28px] sm:rounded-[40px] p-4 sm:p-8 md:p-10 bg-[#f8fcfb] shadow-2xl relative space-y-6 sm:space-y-8 w-full overflow-hidden">
        ...
        {/* 📊 SECTION 2: PAST GENERATED REELS GALLERY */}
        <section className="bg-white border border-slate-200 shadow-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 space-y-6 text-slate-800">
          <div className="border-b border-slate-100 pb-4 flex justify-between items-center flex-wrap gap-3">
            <div>
              ...
              <p className="text-sm font-semibold text-slate-500 mt-1">
                Browse, preview & re-download all previously generated Jamin24 property reels.
              </p>
            </div>
            <button
            ...
            >
              {isLoadingPastReels ? "⏳ Refreshing..." : "🔄 Refresh Gallery"}
            </button>
          </div>

          {pastReels.length === 0 ? (
            <div className="border-2 border-dashed border-slate-200 rounded-2xl p-10 text-center text-slate-500 font-semibold text-sm sm:text-base bg-slate-50/50">
              📹 No past generated reels found yet. Merge your first clip above to see your generated reels here!
            </div>
          ) : (
