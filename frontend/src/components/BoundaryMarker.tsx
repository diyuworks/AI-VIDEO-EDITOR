    ...
    <div className="flex flex-col gap-4 w-full mt-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <button
          ...
          className="py-3 px-3 bg-[#0D473B] hover:bg-[#09352C] text-white font-bold rounded-xl shadow-md text-sm transition disabled:opacity-40 disabled:cursor-not-allowed"
        >
          {confirmButtonText}
        </button>
      </div>
